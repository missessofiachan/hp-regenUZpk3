...
* **Three Unique Healing Modes:** Switch between Standard Cap (percentage-based) and Segment-Based (chunked) regeneration.
...
| `mod_regen_mode` | `0` | `0`, `1`, `2` | **0:** Standard Cap %, **1:** Wolfenstein (20 HP Segments), **2:** Quake (25 HP Segments) |
...
### 2. Segment-Based Regeneration (`mod_regen_mode 1` & `mod_regen_mode 2`)
Instead of restoring health to a static percentage cap, these modes divide your health pool into sequential, independent **segments** (or "health chunks").
* **Wolfenstein Mode (`mod_regen_mode 1`):** Divides health into **20 HP** blocks (0-20, 21-40, 41-60, 61-80, 81-100).
* **Quake Champions Mode (`mod_regen_mode 2`):** Divides health into **25 HP** blocks (0-25, 26-50, 51-75, 76-100).
